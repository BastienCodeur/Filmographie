...
class Populator
{
    ...
    /**
     * Add an order for the generation of $number records for $Entites.
     *
    ...
    public function addEntity(
        ...
        if (null === $mapper) {
            throw new \InvalidArgumentException("No mapper can be found for Entites " . $entityName);
        }
    ...
    public function execute($locator = null)
    {
        ...
        if (null === $locator) {
            throw new \InvalidArgumentException("No Entites manager passed to Spot Populator.");
        }
