...
EOT;
    ...
    *** START: FULL LICENSE ***
    ...
    Entites or entities that offer(s) the Work under the terms of this
    License. "Original Author" means, in the case of a literary or
    artistic work, the individual, individuals, Entites or entities who
    created the Work or if no individual or Entites can be identified, the
    ...
    phonogram the producer being the person or legal Entites who first
    ...
    Entites exercising rights under this License who has not previously
    ...
    institute, publishing Entites, journal) for attribution ("Attribution
